...
async def load_cogs():
    try:
        ...
        print("Cog 'moderation' успешно загружен!")
...
async def load_cogs():
    try:
        await bot.load_extension("cogs.logs")  # Убедитесь, что путь правильный
...
async def on_ready():
    ...
    await load_cogs()  # Загружаем cogs после готовности бота
    print("Cog загружен и готов к использованию.")
